...
<div className='grid grid-cols-3'>
    ...
    <div className="flex flex-col justify-center h-[70vh] bg-cover bg-center"
         style={{ backgroundImage: `url('/https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGV2ZW50JTIwcGxhbm5pbmd8ZW58MHx8MHx8fDA%3D')` }}>
